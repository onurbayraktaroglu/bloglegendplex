...
export default function News({ ResearchList }) {
  const [allItems, setAllItems] = useState(ResearchList.List);
  ...
  return (
    <>
    <Navigation />
    <main className='main bg-themes-main-wrapper-big-x-right payment-c careers-w' style={{ marginTop: '72px' }}>
      <div className='container' style={{ zIndex: '9', }}>
        <div className="row">
          <div className="col-md-6">
            <div className="card-body">
              <h1 className="card-title">News & Blog</h1>
              <p className='card-text'>Stay updated on all the latest news, insights and trends from Bitcoin Suisse.</p>
            </div>
          </div>
        </div>
      </div>
      <div className='bg-themes-big-x'>
      <img src='/images/demo-banner-36.svg' alt="..." resizeMode="contain" className="img-fluid rounded-start" style={{ width: '100%', height: 'auto' }}/>
      </div>
    </main>
    <main className='main'>
            ...
            <div className="row">
                <div className="d-flex list-page-container" style={{ position: 'relative' }}>
                  <div className="pdf-accordion-numb" style={{ marginTop: '20px' }}>
                    ...
                    <button id="act-2" className={`btn btn-light btn-light-new border rounded-pill ${activeCategory === 2 ? 'active' : ''}`} onClick={(e) => blogAccordionMenu(2)}>General</button>
                    <button id="act-3" className={`btn btn-light btn-light-new border rounded-pill ${activeCategory === 3 ? 'active' : ''}`} onClick={(e) => blogAccordionMenu(3)}>Culture</button>
                  </div>
