...
export default function ResearchOutlook({ ResearchList }) {
      ...
      <div className='container' style={{ zIndex: '9', }}>
        <div className="row">
          <div className="col-md-6">
            ...
            <h1 className="card-title">Crypto Outlook 2023</h1>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-12 research-breadcrumb">
                  ...
                  <Link className="scnd" href="/research/outlook"> Legendplex Outlook</Link>
                </div>
