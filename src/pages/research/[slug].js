...
export default function Research({ blog }) {
    const [listDetail, setListDetail] = useState(ResearchList.List);
        ...
        <div className='container'>
            <div className='row'>
                ...
                <div className='detail-breadcrumb'>
                    <Link href="/research">Research </Link>&nbsp;/ <span>&nbsp;{newList.url} / </span>
                </div>
...
export const getServerSideProps = async (context) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/data/researchData.json`).then((r) => r.json());
