...
export default function ResearchCrypto({ ResearchList }) {
      ...
      <div className='container' style={{ zIndex: '9', }}>
        <div className="row">
          <div className="col-md-6">
            ...
            <h1 className="card-title">Crypto & Macro Crypto Outlook Research 2023</h1>
              <p className="card-text">We provide an in-depth look at selected topics ranging from cryptocurrency fundamentals to market analyses. Subscribe below to receive the latest issue directly to your inbox.</p>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-12 research-breadcrumb">
                  ...
                  <Link className="scnd" href="/research/crypto-macro"> Legendplex Crypto & Macro Report</Link>
                </div>
