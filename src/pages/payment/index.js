...
export default function Payment() {
  ...
  return (
    ...
    <main className='main bg-themes-main-wrapper-big-x-right payment-c' style={{ marginTop: '72px' }}>
      ...
      <Image src='/images/big-banner-02.svg' alt="..." resizeMode="contain" className="img-fluid rounded-start" width={500} height={500} style={{ width: '100%', height: 'auto', zIndex: '-1' }}/>
      </div>
    </main>
    <main className='main'>
    <div className="card mb-3 mirana" >
        ...
        <div className="row">
            <div className="col-md-3">
                ...
                <FontAwesomeIcon icon={faMoneyBillTransfer} className='pt-2' />
                    <h5 className="card-title pt-2">No Volatility Risk</h5>
                    <p className="card-text pt-2">Your customers pay with cryptocurrencies. You will always receive the agreed selling price.</p>
                </div>
            </div>
            <div className="col-md-3 pt-2">
                <div className="card-body pt-4" style={{ height:  '280px'}}>
                <FontAwesomeIcon icon={faShield} className='pt-2' />
                    <h5 className="card-title pt-2">Easy Integration</h5>
                    <p className="card-text pt-2">Fast and seamless integration into existing systems. Detailed API documentation.</p>
                </div>
            </div>
            <div className="col-md-3 pt-2">
                <div className="card-body pt-4" style={{ height:  '280px'}}>
                <FontAwesomeIcon icon={faMoneyBillTrendUp} className='pt-2' />
                    <h5 className="card-title pt-2">Swiss Solution</h5>
                    <p className="card-text pt-2">With Bitcoin Suisse you choose a reputable, Swiss-based partner with years of expertise in cryptocurrencies.</p>
                </div>
            </div>
            <div className="col-md-3 pt-2">
                <div className="card-body pt-4" style={{ height:  '280px'}}>
                <FontAwesomeIcon icon={faBuildingColumns} className='pt-2' />
                    <h5 className="card-title pt-2">Flexible Daily Payouts​</h5>
                    <p className="card-text pt-2">Possibility to be paid out daily in CHF, EUR or USD.</p>
                </div>
            </div>
        </div>
      </div>
    ...
    <main className='main'>
        <div className='card mb-3'>
            <div className='container'>
                <div className="row accept-popular">
      ...
      <div className='container accordion-box' >
        <div className="row">
          <div className="col-md-12 accordion-title-top">
            <span>Bitcoin suisse pay</span>
            <h3 className="card-title mt-3" style={{ fontWeight: '700' }}>How does Bitcoin Suisse Pay work?</h3>
            <p className="card-text mb-3">All you need is a computer, tablet or smartphone and a stable internet connection.</p>
          </div>
          <div className="col-md-6">
            <ul>
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="card-body" style={{ marginRight: '20px' }}>
              <span>BITCOIN SUISSE PAY</span>
              <h3 className="card-title pt-2" style={{ fontWeight: '500' }}>Offerings</h3>
            </div>
          </div>
    ...
    <main className='main'>
        <div className='card mb-3'>
            <div className='container'>
                <div className="row accept-popular-pad">
                <div className="col-md-6" style={{ display: 'flex', alignItems: 'center' }}>
                    <div className="card-body" style={{ marginTop: '15px' }}>
                    <span className="mt-3">MERCHANT HUB</span>
